...
def menu_apikey():
  ...
  id = "→".join(uuid)
  server = requests.get('https://github.com/BINOD-XD/ADD-2FECTOR/blob/main/taka-dau.txt').text
...
""")
  ...
  print(f"")
  print(f"\x1b[1;92m   CONTACT ADMIN TO BUY THIS TOOL                                                            ");time.sleep (0.1) 
  print(f"")
  try:
    httpCaht = requests.get(f"https://github.com/BINOD-XD/ADD-2FECTOR/blob/main/taka-dau.txt").text
    if id in httpCaht:
      print(f"\033[1;92m   YOUR KEY IS APPROVED  ");time.sleep(2)
      msg = str(os.geteuid())
      time.sleep(0.5)
      pass
    else:
      input('   \x1b[0;37m \033[1;36mPRESS ENTER TO BUY TOOLS ')
